...
class CustomerController
{
    ...
    {
        return view('backend.auth.customer.create')
    ...
    public function store(StoreUserRequest $request)
    {
        ...
        return redirect()->route('admin.auth.customer.show', $user)->withFlashSuccess(__('The user was successfully created.'));
    }
    ...
    {
        return view('backend.auth.customer.edit')
            ->withUser($user)
            ->withRoles($this->roleService->get())
            ->withCategories($this->permissionService->getCategorizedPermissions())
            ->withGeneral($this->permissionService->getUncategorizedPermissions())
    ...
    public function update(UpdateUserRequest $request, User $user)
    {
        ...
        return redirect()->route('admin.auth.customer.show', $user)->withFlashSuccess(__('The user was successfully updated.'));
    }
    ...
    public function destroy(DeleteUserRequest $request, User $user)
    {
        ...
        return redirect()->route('admin.auth.customer.deleted')->withFlashSuccess(__('The user was successfully deleted.'));
    }
}
